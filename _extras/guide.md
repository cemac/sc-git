...
## [Conflicts]({{ page.root }}{% link _episodes/11-conflict.md %})
...
## [Open Science]({{ page.root }}{% link _episodes/12-open.md %})

## [Licensing]({{ page.root }}{% link _episodes/13-licensing.md %})
...
## [Citation]({{ page.root }}{% link _episodes/14-citation.md %})

## [Hosting]({{ page.root }}{% link _episodes/15-hosting.md %})
